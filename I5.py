...
#    print w
    ...
    return fm
URL='I0129.aanderaa.realtime.nc'
ds = Dataset(URL,'r').variables
f5=np.load('FVCOM_GOM3_GoMOOS_I01_201406.npy').tolist()

f6=np.load('FVCOM_GOM3_GoMOOS_I01_201407.npy').tolist()

f7=np.load('FVCOM_GOM3_GoMOOS_I01_201408.npy').tolist()

f8=np.load('FVCOM_GOM3_GoMOOS_I01_201409.npy').tolist()


f9=np.load('FVCOM_GOM3_GoMOOS_I01_201410.npy').tolist()

f10=np.load('FVCOM_GOM3_GoMOOS_I01_201411.npy').tolist()

f11=np.load('FVCOM_GOM3_GoMOOS_I01_201412.npy').tolist()
...
plt.savefig('mooring I2014-6-1 TO 2015-6-5',dpi=400)

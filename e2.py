...
#    print w
    ...
    return fm
URL='I0125.aanderaa.realtime.nc'
ds = Dataset(URL,'r').variables
f5=np.load('FVCOM_GOM3_GoMOOS_I01_201106.npy').tolist()

f6=np.load('FVCOM_GOM3_GoMOOS_I01_201107.npy').tolist()

f7=np.load('FVCOM_GOM3_GoMOOS_I01_201108.npy').tolist()

f8=np.load('FVCOM_GOM3_GoMOOS_I01_201109.npy').tolist()


f9=np.load('FVCOM_GOM3_GoMOOS_I01_201110.npy').tolist()

f10=np.load('FVCOM_GOM3_GoMOOS_I01_201111.npy').tolist()

f11=np.load('FVCOM_GOM3_GoMOOS_I01_201112.npy').tolist()


f12=np.load('FVCOM_GOM3_GoMOOS_I01_201201.npy').tolist()

f13=np.load('FVCOM_GOM3_GoMOOS_I01_201202.npy').tolist()

f14=np.load('FVCOM_GOM3_GoMOOS_I01_201203.npy').tolist()

f15=np.load('FVCOM_GOM3_GoMOOS_I01_201204.npy').tolist()
'''
...
plt.savefig('mooring I2011-6-3TO 2012-4-13',dpi=400)

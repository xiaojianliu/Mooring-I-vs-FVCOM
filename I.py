...
#    print w
    ...
    return fm
URL='I0124.aanderaa.realtime.nc'
ds = Dataset(URL,'r').variables
f5=np.load('FVCOM_GOM3_GoMOOS_I01_201006.npy').tolist()

f6=np.load('FVCOM_GOM3_GoMOOS_I01_201007.npy').tolist()

f7=np.load('FVCOM_GOM3_GoMOOS_I01_201008.npy').tolist()

f8=np.load('FVCOM_GOM3_GoMOOS_I01_201009.npy').tolist()


f9=np.load('FVCOM_GOM3_GoMOOS_I01_201010.npy').tolist()

f10=np.load('FVCOM_GOM3_GoMOOS_I01_201011.npy').tolist()

f11=np.load('FVCOM_GOM3_GoMOOS_I01_201012.npy').tolist()


f12=np.load('FVCOM_GOM3_GoMOOS_I01_201101.npy').tolist()

f13=np.load('FVCOM_GOM3_GoMOOS_I01_201102.npy').tolist()

f14=np.load('FVCOM_GOM3_GoMOOS_I01_201103.npy').tolist()

f15=np.load('FVCOM_GOM3_GoMOOS_I01_201104.npy').tolist()
f16=np.load('FVCOM_GOM3_GoMOOS_I01_201105.npy').tolist()

f17=np.load('FVCOM_GOM3_GoMOOS_I01_201106.npy').tolist()
'''
...
plt.savefig('mooring I2010-6-8TO 2011-6-3',dpi=400)

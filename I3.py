...
#    print w
    ...
    return fm
URL='I0127.aanderaa.realtime.nc'
ds = Dataset(URL,'r').variables
f5=np.load('FVCOM_GOM3_GoMOOS_I01_201210.npy').tolist()

f6=np.load('FVCOM_GOM3_GoMOOS_I01_201211.npy').tolist()

f7=np.load('FVCOM_GOM3_GoMOOS_I01_201212.npy').tolist()

f8=np.load('FVCOM_GOM3_GoMOOS_I01_201301.npy').tolist()


f9=np.load('FVCOM_GOM3_GoMOOS_I01_201302.npy').tolist()

f10=np.load('FVCOM_GOM3_GoMOOS_I01_201303.npy').tolist()

f11=np.load('FVCOM_GOM3_GoMOOS_I01_201304.npy').tolist()


f12=np.load('FVCOM_GOM3_GoMOOS_I01_201305.npy').tolist()

f13=np.load('FVCOM_GOM3_GoMOOS_I01_201306.npy').tolist()
'''
f14=np.load('FVCOM_GOM3_GoMOOS_I01_201307.npy').tolist()

f15=np.load('FVCOM_GOM3_GoMOOS_I01_201308.npy').tolist()
f16=np.load('FVCOM_GOM3_GoMOOS_I01_201309.npy').tolist()

f17=np.load('FVCOM_GOM3_GoMOOS_I01_201310.npy').tolist()
...
axes[0].plot(t,sh_rmtide(currentu),label='mooring I')
axes[0].set_ylabel('''m/s''')
axes[0].legend(loc='best')
#plt.show()
axes[1].set_title('v')
axes[1].plot(time,sh_rmtide(v),label='fvcom')
axes[1].plot(t,sh_rmtide(currentv),label='mooring I')
...
axes[2].plot(t,speedm,label='mooring I')
axes[2].legend(loc='best')
plt.savefig('mooring I2012-10-26 TO 2013-6-23',dpi=400)

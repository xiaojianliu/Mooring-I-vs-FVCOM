...
#    print w
    ...
    return fm
URL='I0103.aanderaa.realtime.nc'
ds = Dataset(URL,'r').variables
f5=np.load('FVCOM_GOM3_GoMOOS_I01_200207.npy').tolist()

f6=np.load('FVCOM_GOM3_GoMOOS_I01_200208.npy').tolist()

f7=np.load('FVCOM_GOM3_GoMOOS_I01_200209.npy').tolist()

f8=np.load('FVCOM_GOM3_GoMOOS_I01_200210.npy').tolist()


f9=np.load('FVCOM_GOM3_GoMOOS_I01_200211.npy').tolist()

f10=np.load('FVCOM_GOM3_GoMOOS_I01_200212.npy').tolist()

f11=np.load('FVCOM_GOM3_GoMOOS_I01_200301.npy').tolist()
'''

f12=np.load('FVCOM_GOM3_GoMOOS_I01_201501.npy').tolist()

f13=np.load('FVCOM_GOM3_GoMOOS_I01_201502.npy').tolist()

f14=np.load('FVCOM_GOM3_GoMOOS_I01_201503.npy').tolist()

f15=np.load('FVCOM_GOM3_GoMOOS_I01_201504.npy').tolist()
f16=np.load('FVCOM_GOM3_GoMOOS_I01_201505.npy').tolist()

f17=np.load('FVCOM_GOM3_GoMOOS_I01_201506.npy').tolist()
...
plt.savefig('mooring I2002-7-24 TO 2003-1-15',dpi=400)

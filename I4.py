...
#    print w
    ...
    return fm
URL='I0128.aanderaa.realtime.nc'
ds = Dataset(URL,'r').variables
f5=np.load('FVCOM_GOM3_GoMOOS_I01_201306.npy').tolist()

f6=np.load('FVCOM_GOM3_GoMOOS_I01_201307.npy').tolist()

f7=np.load('FVCOM_GOM3_GoMOOS_I01_201308.npy').tolist()

f8=np.load('FVCOM_GOM3_GoMOOS_I01_201309.npy').tolist()


f9=np.load('FVCOM_GOM3_GoMOOS_I01_201310.npy').tolist()

f10=np.load('FVCOM_GOM3_GoMOOS_I01_201311.npy').tolist()

f11=np.load('FVCOM_GOM3_GoMOOS_I01_201312.npy').tolist()


f12=np.load('FVCOM_GOM3_GoMOOS_I01_201401.npy').tolist()

f13=np.load('FVCOM_GOM3_GoMOOS_I01_201402.npy').tolist()

f14=np.load('FVCOM_GOM3_GoMOOS_I01_201403.npy').tolist()

f15=np.load('FVCOM_GOM3_GoMOOS_I01_201404.npy').tolist()
f16=np.load('FVCOM_GOM3_GoMOOS_I01_201405.npy').tolist()
'''
...
plt.savefig('mooring I2013-6-24 TO 2014-5-31',dpi=400)

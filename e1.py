...
#    print w
    ...
    return fm
URL='I0126.aanderaa.realtime.nc'
ds = Dataset(URL,'r').variables
f5=np.load('FVCOM_GOM3_GoMOOS_I01_201204.npy').tolist()

f6=np.load('FVCOM_GOM3_GoMOOS_I01_201205.npy').tolist()

f7=np.load('FVCOM_GOM3_GoMOOS_I01_201206.npy').tolist()

f8=np.load('FVCOM_GOM3_GoMOOS_I01_201207.npy').tolist()


f9=np.load('FVCOM_GOM3_GoMOOS_I01_201208.npy').tolist()

f10=np.load('FVCOM_GOM3_GoMOOS_I01_201209.npy').tolist()

f11=np.load('FVCOM_GOM3_GoMOOS_I01_201210.npy').tolist()
'''

f12=np.load('FVCOM_GOM3_GoMOOS_I01_201004.npy').tolist()

f13=np.load('FVCOM_GOM3_GoMOOS_I01_201005.npy').tolist()

f14=np.load('FVCOM_GOM3_GoMOOS_I01_201006.npy').tolist()
...
plt.savefig('mooring I2012-4-13 TO 2012-10-25',dpi=400)
